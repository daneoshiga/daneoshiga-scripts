...
gpo update "http://gdata.youtube.com/feeds/base/users/CHOW/uploads?alt=rss&v=2&orderby=published&client=ytapi-youtube-profile"
gpo download "http://gdata.youtube.com/feeds/base/users/CHOW/uploads?alt=rss&v=2&orderby=published&client=ytapi-youtube-profile"
gpo download "http://gdata.youtube.com/feeds/base/users/kincommunity/uploads?orderby=updated&alt=rss&client=ytapi-youtube-rss-redirect&v=2"
